      ...
      <section className="py-6 md:py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-6 md:mb-16">
            ...
            >
              <p className="text-xs md:text-xl text-gray-700 leading-relaxed mb-2 md:mb-4">
                Revolutionizing education through innovation, technology, and industry integration
              </p>
            </div>
          </div>
                ...
                {[
                  {
                    ...
                    desc: "Personalized curriculum with adaptive AI technology",
                    color: "from-[#22336a] to-[#3b4d7a]",
                  },
                  {
                    icon: Users,
                    title: "Industry Mentorship",
                    desc: "Direct guidance from Fortune 500 executives",
                    color: "from-[#c38935] to-[#f4d03f]",
                  },
                  {
                    icon: Award,
                    title: "Digital Credentials",
                    desc: "Blockchain-verified certifications and achievements",
                    color: "from-[#22336a] to-[#3b4d7a]",
                  },
                  {
                    icon: Zap,
                    title: "Virtual Reality Labs",
                    desc: "Immersive learning through VR and AR technology",
                    color: "from-[#c38935] to-[#f4d03f]",
                  },
                ].map((offering, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 w-60 bg-white rounded-lg p-3 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 transform hover:scale-105 relative"
                  >
                    <div
                      className={`w-10 h-10 bg-gradient-to-r ${offering.color} rounded-lg flex items-center justify-center mb-2`}
                    >
            ...
            {[
              {
                icon: BookOpen,
                title: "AI-Powered Learning",
                desc: "Experience personalized education with adaptive AI technology that adjusts to your learning pace and style for maximum effectiveness.",
                color: "from-[#22336a] to-[#3b4d7a]",
              },
              {
                icon: Users,
                title: "Industry Mentorship",
                desc: "Learn directly from Fortune 500 executives, startup founders, and industry leaders who bring real-world insights to your education.",
                color: "from-[#c38935] to-[#f4d03f]",
              },
              {
                icon: Award,
                title: "Digital Credentials",
                desc: "Earn blockchain-verified certifications and digital badges that are recognized globally by leading employers and institutions.",
                color: "from-[#22336a] to-[#3b4d7a]",
              },
              {
                icon: Zap,
                title: "Virtual Reality Labs",
                desc: "Immerse yourself in cutting-edge VR and AR learning environments that bring complex concepts to life through interactive experiences.",
                color: "from-[#c38935] to-[#f4d03f]",
              },
            ].map((offering, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-center group hover-lift"
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${offering.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
